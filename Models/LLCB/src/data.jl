function ko_summary_data_path()
    ...
    path = "/home/students/jihgu/RNAseq-perturbation-CD4-pipeline-master/output/diffeq/txt/differential_expression_results_regressed_pcs.tsv"
    if !isfile(path)
...
function ko_rnaseq_data_path()
    ...
    path = "/home/students/jihgu/RNAseq-perturbation-CD4-pipeline-master/output/diffeq/txt/vst_normalized_counts_transpose.tsv"
    #path = "C:/Users/JiHun/OneDrive - UGent/바탕 화면/Master/MS3/Thesis/RNAseq-perturbation-CD4-pipeline-master/data/counts/vst_normalized_counts_transpose_pro.tsv"
    if !isfile(path)
...
function covariates_path()
    ...
    path = "/home/students/jihgu/RNAseq-perturbation-CD4-pipeline-master/output/diffeq/txt/covariates.tsv"
...
function simulated_data_dir()
    ...
    dir = "/home/students/jihgu/LLCB-Server/network_inference/ground_truth_simulation/output"
    return dir
end
...
function output_dir()
    ...
    return "/home/students/jihgu/LLCB-Server/network_inference/InferCausalGraph/output"
end
...
@memoize function read_metadata(path = "/home/students/jihgu/RNAseq-perturbation-CD4-pipeline-master/data/metadata/sample_meta_data.tsv")
...
@memoize function read_symbol_ensid_lookup(path = "/home/students/jihgu/RNAseq-perturbation-CD4-pipeline-master/output/diffeq/txt/txdb.tsv")
    # summary = read_ko_summary_data()
